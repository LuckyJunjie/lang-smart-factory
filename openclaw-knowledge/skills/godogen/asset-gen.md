...
Tools live at `.cursor/skills/godogen/tools/`. Run from the project root.

### Generate image (5-10 cents)

```bash
python3 .cursor/skills/godogen/tools/asset_gen.py image \
...
Uses rembg mask + alpha matting. Handles semi-transparent objects, fine edges, hair, glass, particles. Auto-detects the background color from corner pixels. Dependencies in `.cursor/skills/godogen/tools/requirements.txt`.
...
```bash
python3 .cursor/skills/godogen/tools/rembg_matting.py \
...
```bash
python3 .cursor/skills/godogen/tools/asset_gen.py spritesheet \
...
python3 .cursor/skills/godogen/tools/spritesheet_slice.py keep-bg \
  assets/img/knight_raw.png -o assets/img/knight.png

# Remove background (sprites, characters — preferred)
python3 .cursor/skills/godogen/tools/spritesheet_slice.py clean-bg \
  assets/img/knight_raw.png -o assets/img/knight.png
```
...
python3 .cursor/skills/godogen/tools/spritesheet_slice.py split-bg \
  assets/img/items_raw.png -o assets/img/items/

# Split with background removed (preferred for in-game objects)
python3 .cursor/skills/godogen/tools/spritesheet_slice.py split-clean \
  assets/img/items_raw.png -o assets/img/items/ \
...
```bash
python3 .cursor/skills/godogen/tools/asset_gen.py glb \
...
```bash
python3 .cursor/skills/godogen/tools/asset_gen.py set_budget 500
```
