#!/usr/bin/env python3
"""
Team Sync - Run hourly via cron on each team machine.
Preferred: python -m skills.team_sync --team <team> (from smart-factory root).
...
if __name__ == "__main__":
    from skills.team_sync import main
    sys.exit(main())
