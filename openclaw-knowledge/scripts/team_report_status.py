#!/usr/bin/env python3
"""
Team Status Reporter - Run every 30 min via cron.
Preferred: python -m skills.report_team_status --team <team> (from smart-factory root).
...
if __name__ == "__main__":
    from skills.report_team_status import main
    sys.exit(main())
